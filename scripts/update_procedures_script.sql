...
create procedure sp_update_sexo(IN id INT,IN descricao_sexo varchar(250))
begin
	update sexo set descricao_sexo=descricao_sexo where idSexo=id;
end;|

create procedure sp_update_cidade(IN id INT,IN descCidade varchar(250),IN DDD INT)
begin
	update cidade set descCidade=descCidade, DDD=DDD where idCidade=id;
end;|

create procedure sp_update_endereco(IN id INT,IN rua varchar(250),IN bairro varchar(250), numero varchar(250), cep INT, complemento varchar(250), Cidade_idCidade INT)
begin
...
create procedure sp_update_buraco(id_buraco INT, tamanho varchar(250), localizacao varchar(250), prioridade varchar(250), Endereco_idEndereco INT) 
begin
...
create procedure sp_update_pessoa(cpf1 INT, telefone INT, nome_pai varchar(250), nome_mae varchar(25), Endereco_idEndereco INT, Sexo_idSexo INT, nome_solteiro varchar(250), nome_casado varchar(250))
begin
